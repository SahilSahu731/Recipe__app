    ...
    return (
        <div className='container mx-auto py-10 grid grid-cols-1 lg:grid-cols-2 gap-10'>
            ...
            <div className='flex flex-col gap-3'>
                ...
                <h3 className='font-bold text-2xl  truncate'>{recipeDetailsData?.recipe?.title}</h3>
                <div>
                    <button
                    ...
                    >
                        {
                           favoriteList && favoriteList.length > 0 && favoriteList.findIndex(item => item.id === recipeDetailsData?.recipe?.id ) !== -1 ? 'Remove from Favorites' : 'Add to Favorites'
                        }
                    </button>
                </div>
                <div>
